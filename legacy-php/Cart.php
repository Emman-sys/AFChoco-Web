...
// Get user information for pre-filling checkout form (including phone and address)
$user_stmt = $conn->prepare("SELECT name, email, phone_number, address FROM users WHERE user_id = ?");
if (!$user_stmt) {
